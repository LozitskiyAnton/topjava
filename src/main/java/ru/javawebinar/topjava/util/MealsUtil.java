...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное значение юзера №2", 100, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак юзера №2", 1000, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед юзера №2", 500, 2),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин юзера №2", 410, 2)
    );
